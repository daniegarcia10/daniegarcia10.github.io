...
let HomePage = class HomePage {
    constructor(langService, requestService) {
...
let RequestService = class RequestService {
    constructor(httpClient, http, platform, translateService) {
        this.httpClient = httpClient;
        this.http = http;
        this.platform = platform;
        this.translateService = translateService;
    }
    httpRequest(path, headers, params = {}) {
        ...
        return new Promise(resolve => {
            console.log('init');
            const postSub = this.httpClient.post(url, '', {
                headers,
                params
