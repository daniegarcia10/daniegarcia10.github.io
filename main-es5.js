        ...
        _createClass(HeaderComponent, [{
          ...
          value: function ngOnInit() {
            ...
            var debounce = function debounce(fn) {
              console.log('debounce'); // This holds the requestAnimationFrame reference, so we can cancel it if we wish
            ...
            document.addEventListener('scroll', debounce(storeScroll)); // Update scroll position for first time
      ...
      var ProductSectionComponent = /*#__PURE__*/function () {
        function ProductSectionComponent() {
          ...
          this.products = [{
            ...
            dsc: ['Contiene proteina de alto valor biológico.', 'Es rica en fibra que ayuda a saciar y regular la flora intestinal.', 'Aporta minerales como magnesio, forforo, potasio y vitaminas del grupo A y B, C, D, y K.', 'No contiene grasas añadidas ni conservadores.'],
